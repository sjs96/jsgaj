...
import weixin.entity.PayAttach;
import weixin.kit.ZxingKit;
import weixin.model.Order;
import weixin.utils.StringUtils;
import weixin.vo.AjaxResult;
...
public class WeixinPayController extends ApiController {
	...
	String notify_url = PropKit.get("domain")+"/api/weixin_pay/pay_notify";
	...
	public void index() {
		...
		renderJson(Util.getResultMap(Util.state_ok,"有数据",packageParams,Util.level_info,Util.model_dev));
	}
